                ...
                <div class="relative w-screen max-w-md" x-on:click.away=" isOpenModal = false">
                    <div class="flex flex-col h-full py-6 bg-white">
                        <div class="flex px-4 sm:px-6">
                            <button
                                class="w-5 text-gray-400 rounded-md hover:text-gray-200 focus:outline-none focus:ring-2 focus:ring-white transition"
                            ...
                            <h2 id="slide-over-heading"
                                class="font-mono flex-1 text-lg font-medium text-right text-gray-900">
                                {{ $title }}
                            </h2>
                        </div>
