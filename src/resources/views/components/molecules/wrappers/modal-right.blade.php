            ...
            <div class="relative w-screen max-w-md" x-on:click.away=" isOpenModal = false">
               <div class="flex flex-col h-full py-6 bg-white shadow-xl">
                  <div class="flex px-4 sm:px-6">
                     <h2 id="slide-over-heading" class="font-mono flex-1 text-lg font-medium text-gray-900">
                        {{ $title }}
                     </h2>
                     <button class="w-5 text-gray-500 rounded-md hover:text-gray-200 focus:outline-none focus:ring-2 focus:ring-white" x-on:click="isOpenModal = false">
